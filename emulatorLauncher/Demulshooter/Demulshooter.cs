...
namespace EmulatorLauncher
{
    class Demulshooter
    {
        ...
        internal static readonly Dictionary<string, TeknoParrotGame> teknoParrotGames = new Dictionary<string, TeknoParrotGame>
        {
            ...
            { "MIB", new TeknoParrotGame { XmlName = "MIB", RomName = "mib", Architecture = "x64", Target = "arcadepc", ExtraArgs = "" } },
            ...
            { "RobinHood", new TeknoParrotGame { XmlName = "RobinHood", RomName = "rhood", Architecture = "x32", Target = "arcadepc", ExtraArgs = "" } },            
            ...
            { "TargetBravo", new TeknoParrotGame { XmlName = "TargetBravo", RomName = "tb", Architecture = "x32", Target = "ringwide", ExtraArgs = "" } },
        ...
        internal static readonly Dictionary<string, ExeLauncherGame> exeLauncherGames = new Dictionary<string, ExeLauncherGame>
        {
            ...
            { "meninblack", new ExeLauncherGame { RomName = "mib", Architecture = "x64", Target = "arcadepc" } },
