...
namespace EmulatorLauncher
{
    partial class MameHooker
    {
        public static class Flycast
        {
            ...
            public static bool ConfigureFlycast(string romName)
            {
                // Check if this is a supported lightgun game
                if (!SupportedGames.Contains(romName))
                {
                    SimpleLogger.Instance.Info("[INFO] Not a supported Flycast lightgun game, skipping configuration");
                    return false;
                }
