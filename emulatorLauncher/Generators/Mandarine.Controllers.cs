...
namespace EmulatorLauncher
{
    partial class MandarineGenerator : Generator
    {
        ...
        private void ConfigureJoystick(Controller controller, IniFile ini)
        {
            ...
            string newGuid = SdlJoystickGuid.GetGuidFromFile(newGuidPath, controller.SdlController, controller.Guid, "mandarine", 0, batPath);
            if (newGuid != null)
            ...
            if (Program.SystemConfig.isOptSet("mandarine_touchprofile") && !string.IsNullOrEmpty(Program.SystemConfig["mandarine_touchprofile"]))
            {
                string touch_profile = Program.SystemConfig["mandarine_touchprofile"];
        ...
        private void ConfigureShortcuts(IniFile ini)
        {
            ...
            ini.WriteValue("UI", "Shortcuts\\Main%20Window\\Exit%20Mandarine\\KeySeq\\default", "false");
            ini.WriteValue("UI", "Shortcuts\\Main%20Window\\Exit%20Mandarine\\KeySeq", "Esc");
