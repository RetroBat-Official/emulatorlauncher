    ...
    class DolphinControllers
    {
        ...
        */
        ...
        private static void generateControllerConfig_emulatedwiimotes(string path, string rom)
        {
            ...
            if (Program.SystemConfig["classic_controller"] != "1" && Program.SystemConfig["wiimote_side"] == "1")
            {
            ...
            if (Program.SystemConfig["classic_controlle"] != "1" && (Program.SystemConfig["controller_mode"] == "is" || Program.SystemConfig["controller_mode"] == "it" || Program.SystemConfig["controller_mode"] == "in"))
            {
            ...
            if (Program.SystemConfig["classic_controlle"] != "1" && (Program.SystemConfig["controller_mode"] == "si" || Program.SystemConfig["controller_mode"] == "ti" || Program.SystemConfig["controller_mode"] == "ni"))
            {
            ...
            if (Program.SystemConfig["classic_controlle"] != "1" && (Program.SystemConfig["controller_mode"] == "si" || Program.SystemConfig["controller_mode"] == "st" || Program.SystemConfig["controller_mode"] == "sn"))
            {
            ...
            if (Program.SystemConfig["classic_controlle"] != "1" && (Program.SystemConfig["controller_mode"] == "is" || Program.SystemConfig["controller_mode"] == "ts" || Program.SystemConfig["controller_mode"] == "ns"))
            {
            ...
            if (Program.SystemConfig["classic_controlle"] != "1" && (Program.SystemConfig["controller_mode"] == "ti" || Program.SystemConfig["controller_mode"] == "ts" || Program.SystemConfig["controller_mode"] == "tn"))
            {
            ...
            if (Program.SystemConfig["classic_controlle"] != "1" && (Program.SystemConfig["controller_mode"] == "it" || Program.SystemConfig["controller_mode"] == "st" || Program.SystemConfig["controller_mode"] == "nt"))
            {
            ...
            if (Program.SystemConfig["classic_controlle"] != "1" && (Program.SystemConfig["controller_mode"] == "ni" || Program.SystemConfig["controller_mode"] == "ns" || Program.SystemConfig["controller_mode"] == "nt"))
            {
            ...
            if (Program.SystemConfig["classic_controlle"] != "1" && (Program.SystemConfig["controller_mode"] == "in" || Program.SystemConfig["controller_mode"] == "sn" || Program.SystemConfig["controller_mode"] == "tn"))
            {
                extraOptions["Extension"] = "Nunchuk";
                wiiMapping[InputKey.l2] = "Nunchuk/Buttons/C";
                wiiMapping[InputKey.r2] = "Nunchuk/Buttons/Z";
            ...
            if (Program.SystemConfig["classic_controller"] == "1")
            {
