...
namespace EmulatorLauncher.Common.Lightguns
{
    public class SindenLightgunConfiguration
    {
        public bool ShowPrimaryBorder
        {
            get
            {
                var custom = Program.SystemConfig["controllers.guns.bordersmode"];
                if (custom == "hidden")
                    return false;
        ...
        public float PrimaryBorderWidth
        {
            get
            {
                var custom = Program.SystemConfig["controllers.guns.borderssize"];
        ...
        public Color PrimaryColor
        {
            get
            {
                var custom = Program.SystemConfig["controllers.guns.borderscolor"];
                if (custom == "white")
                    return Color.White;                
                if (custom == "red")
        ...
        public static SindenLightgunConfiguration GetConfiguration()
        {
            try
            {
                ...
                if (px != null)
                {
                    ...
                    if (cmd != null)
                    {
                        ...
                        if (File.Exists(cmd))
                        {
                            var ret = new SindenLightgunConfiguration();
                            ret._docPath = cmd;
            ...
            return new SindenLightgunConfiguration();
        }

        private SindenLightgunConfiguration() { }
