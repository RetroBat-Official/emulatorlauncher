...
namespace DokanNet
{
    ...
    public sealed class DokanFileInfo : IDokanFileInfo
    {
        ...
        /// </summary>
        public bool PagingIo { get { return _pagingIo; } }

        /// <summary>
        /// Read or write is synchronous IO.
        /// </summary>
        public bool SynchronousIo { get { return _synchronousIo; } }

        /// <summary>
        /// Read or write directly from data source without cache.
        /// </summary>
        public bool NoCache { get { return _noCache; } }

        /// <summary>
        /// If <c>true</c>, write to the current end of file instead 
        /// of using the <c>Offset</c> parameter.
        /// </summary>
        public bool WriteToEndOfFile { get { return _writeToEndOfFile; } }
