...
namespace EmulatorLauncher
{
    partial class Pcsx2Generator : Generator
    {
        ...
        private void SetupWheelQT(IniFile pcsx2ini, string path)
        {
            ...
            int wheelIndex1 = -1;
            int wheelIndex2 = -1;
            bool invertedWheelAxis1 = false;
            bool invertedWheelAxis2 = false;
            Wheel wheel1 = null;
            Wheel wheel2 = null;
            ...
            // Enable dinput as wheels are managed through dinput
            ...
            try 
            {
                ...
                SimpleLogger.Instance.Info("[WHEELS] Using " + wheelmapping1 + " mapping to configure first wheel.");
            }
            catch { SimpleLogger.Instance.Info("[WHEELS] Problem getting wheel 1 mapping in yml file."); }

            wheelGuid1 = wheelmapping1.WheelGuid;
            invertedWheelAxis1 = wheelmapping1.Invertedaxis == "true";
            ...
            if (gamecontrollerDB != null)
            {
                ...
                pcsx2ini.WriteValue(usbSection1, "Pad_FFDevice", "DInput-" + wheelIndex1);
            ...
            if (wheelNb > 1)
            {
                ...
                try 
                {
                    ...
                    SimpleLogger.Instance.Info("[WHEELS] Using " + wheelmapping2 + " mapping to configure second wheel.");
                }
                catch { SimpleLogger.Instance.Info("[WHEELS] Problem getting wheel 2 mapping in yml file."); }

                wheelGuid2 = wheelmapping2.WheelGuid;
                invertedWheelAxis2 = wheelmapping2.Invertedaxis == "true";
                ...
                if (gamecontrollerDB != null)
                {
                    ...
                    pcsx2ini.WriteValue(usbSection1, "Pad_SteeringLeft", GetWheelMapping(sdlWheel2, wheelmapping2.Steer, wheelIndex2, -1));
                    pcsx2ini.WriteValue(usbSection1, "Pad_SteeringRight", GetWheelMapping(sdlWheel2, wheelmapping2.Steer, wheelIndex2, 1));
                    pcsx2ini.WriteValue(usbSection1, "Pad_Start", GetDInputKeyName(wheelIndex2, sdlWheel2, "start"));
                    pcsx2ini.WriteValue(usbSection1, "Pad_Select", GetDInputKeyName(wheelIndex2, sdlWheel2, "back"));
                    pcsx2ini.WriteValue(usbSection1, "Pad_DPadUp", GetDInputKeyName(wheelIndex2, sdlWheel2, "dpup"));
                    pcsx2ini.WriteValue(usbSection1, "Pad_DPadDown", GetDInputKeyName(wheelIndex2, sdlWheel2, "dpdown"));
                    pcsx2ini.WriteValue(usbSection1, "Pad_DPadLeft", GetDInputKeyName(wheelIndex2, sdlWheel2, "dpleft"));
                    pcsx2ini.WriteValue(usbSection1, "Pad_DPadRight", GetDInputKeyName(wheelIndex2, sdlWheel2, "dpright"));
                    pcsx2ini.WriteValue(usbSection1, "Pad_Throttle", GetWheelMapping(sdlWheel2, wheelmapping2.Throttle, wheelIndex2, -1));
                    pcsx2ini.WriteValue(usbSection1, "Pad_Brake", GetWheelMapping(sdlWheel2, wheelmapping2.Brake, wheelIndex2, -1));
                    pcsx2ini.WriteValue(usbSection1, "Pad_Cross", GetDInputKeyName(wheelIndex2, sdlWheel2, "a"));
                    pcsx2ini.WriteValue(usbSection1, "Pad_Circle", GetDInputKeyName(wheelIndex2, sdlWheel2, "b"));
                    pcsx2ini.WriteValue(usbSection1, "Pad_Square", GetDInputKeyName(wheelIndex2, sdlWheel2, "x"));
                    pcsx2ini.WriteValue(usbSection1, "Pad_Triangle", GetDInputKeyName(wheelIndex2, sdlWheel2, "y"));
                    pcsx2ini.WriteValue(usbSection1, "Pad_L1", GetDInputKeyName(wheelIndex2, sdlWheel2, "leftshoulder"));
                    pcsx2ini.WriteValue(usbSection1, "Pad_R1", GetDInputKeyName(wheelIndex2, sdlWheel2, "rightshoulder"));
                    pcsx2ini.WriteValue(usbSection1, "Pad_L2", GetDInputKeyName(wheelIndex2, sdlWheel2, "lefttrigger"));
                    pcsx2ini.WriteValue(usbSection1, "Pad_R2", GetDInputKeyName(wheelIndex2, sdlWheel2, "rightrigger"));
                }
            }
        }
