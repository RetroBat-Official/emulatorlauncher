        ...
        private static void WriteShortcuts(IniFile ini)
        {
            ...
            foreach (var hk in hkList)
            {
                if (ini.GetValue("UI", hk) == "F8" && !hk.Contains("Capture%20Screenshot"))
                    ...
                    ini.WriteValue("UI", hk, "");
                else if (ini.GetValue("UI", hk) == "Esc" && !hk.Contains("Exit%20yuzu"))
                    ini.WriteValue("UI", hk, "");
            ...
            ini.WriteValue("UI", "Shortcuts\\Main%20Window\\Exit%20yuzu\\KeySeq\\default", "false");
            ini.WriteValue("UI", "Shortcuts\\Main%20Window\\Exit%20yuzu\\KeySeq", "Esc");
